...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LD13_Pin|LD14_Pin|SD_CS_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : LD13_Pin LD14_Pin SD_CS_Pin */
  GPIO_InitStruct.Pin = LD13_Pin|LD14_Pin|SD_CS_Pin;
