...
/* Definitions for AlarmManager */
osThreadId_t AlarmManagerHandle;
const osThreadAttr_t AlarmManager_attributes = {
  .name = "AlarmManager",
  .stack_size = 256 * 4,
  .priority = (osPriority_t) osPriorityNormal,
};
...
extern void entry_AlarmManager(void *argument);
extern void entry_ComunicationTask(void *argument);
...
int main(void)
{
  ...
  /* creation of AlarmManager */
  AlarmManagerHandle = osThreadNew(entry_AlarmManager, NULL, &AlarmManager_attributes);

  /* creation of ComunicationTas */
  ComunicationTasHandle = osThreadNew(entry_ComunicationTask, NULL, &ComunicationTas_attributes);

  /* creation of FlashTask */
  FlashTaskHandle = osThreadNew(entry_FlashTask, NULL, &FlashTask_attributes);
...
/* USER CODE BEGIN Header_entry_FlashTask */
/**
...
__weak void entry_FlashTask(void *argument)
{
