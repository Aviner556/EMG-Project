...
/* Configure the peripherals common clocks */
  ...
  /* creation of ADC */
  ADCHandle = osThreadNew(entry_ADC, NULL, &ADC_attributes);
...
/* USER CODE BEGIN Header_entry_ADC */
/**
* @brief Function implementing the ADC thread.
* @param argument: Not used
* @retval None
*/
/* USER CODE END Header_entry_ADC */
__weak void entry_ADC(void *argument)
{
  /* USER CODE BEGIN entry_ADC */
  /* Infinite loop */
  for(;;)
  {
    osDelay(1);
  }
  /* USER CODE END entry_ADC */
}

/* USER CODE BEGIN Header_Entry_DHT */
/**
...
__weak void Entry_DHT(void *argument)
{
